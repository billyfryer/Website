...
![](Plots/Expansion-Draft-Possible-Protections-2025.png)
...
#              total = "Total") %>% 
#   # Header
#   tab_header(title = md("**Toronto/Portland WNBA Expansion Draft Protectable Players**")) %>% 
#   # Footnotes
...
#   # Asterisk for Washington Unsigned Draftees because Nastja Claessens is playing for Kansas State
#   # therefore she is eligible be redrafted.
#   tab_footnote(
...
#     ) %>% 
#   gtsave("Expansion-Draft-Possible-Protections-2025.png")
```
