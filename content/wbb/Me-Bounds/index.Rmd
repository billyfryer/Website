...
Similar to [Josiah Cohen's article](https://riseofthevalkyries.substack.com/p/is-angel-reese-really-the-queen-of), I also decided to look at the proportion of a player's rebounds that were mebounds (MEREB) rather than a true MEREB% which would be the percentage of Player X's misses acquired by them self as opposed to the percentage of Player Y's misses acquired by them self. I did so to make sure I'm not excluding players that may be poor rebounders overall, yet still good at getting their own misses. After setting a minimum qualifier of 20 MEREB on the season, we find that 13.8% of Angel's rebounds during the 2024 seasons were mebounds, a figure that is 5th best all-time on a season-by-season basis. Due to the expanded number of games, Angel Reese did collect the most total MEREB in a single season of any player all-time with 56.

There are plenty of other notable names on this list including Seattle Storm Ring of Honor Member Lauren Jackson and the aforementioned Yolanda Griffith. Perhaps the most interesting name on the list is Cappie Pondexter, an all-star guard that played for Phoenix during their 2009 Championship season. Pondexter stands at 5'9" yet was able to grab her own misses on a team full of size with WNBA stalwarts Tangela Smith and DeWanna Bonner, who at the time was in her rookie season. Pondexter was in her third year and had just been given the fourth-year team option at the end of her rookie contract prior to the 2009 season. Phoenix eventually traded her to New York in a 3-team trade involving Chicago during the off-season.
...
As previously mentioned, Angel led the league by a wide margin for most total mebounds in 2024. This is likely strongly connected to the fact that Reese was also the most blocked player in the WNBA. According to WNBA Stats, 76 of Reese's shots during the 2024 season were blocked. Right behind her was Dearica Hamby of the LA Sparks with 75 before a large gap to everyone else. Both Reese and Hamby are back to the basket post players, playing well below the rim even compared to other WNBA centers and both stand at 6'3". When playing against giants like Jonquel Jones and Brittney Griner (standing at 6'6" and 6'9" respectively), Reese and Hamby are giving up a huge height advantage with no way to overcome it due to their style of play. While WNBA Rim FG% is lower than NBA Rim FG% for a variety of reasons, the below the rim style of play of Angel Reese lowers her Rim FG% even further leading to even more mebound opportunities on which she capitalizes.
