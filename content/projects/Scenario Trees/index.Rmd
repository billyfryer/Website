...
## Computational Speed and Tree Feasibility

Given the exponential growth of the number of rows based on the number of games remaining, there is a dramatic uptick in computation time required by adding a singular game. For now, the computation is reasonable (runs in only a few minutes) for under 20 games remaining. However, the trees at that point can be very hard to read. Further developments are still be added to make the process both faster and generate trees in a more readable way. In the meantime, I would recommend downloading the spreadsheet for faster and better viewing.

## Try It!

Interested in creating your own Scenario Tree? Follow the instructions on the Shiny App below!

The Shiny App is still a work in progress so let me know if anything unusual shows up or you have any suggestions!

<center>
  <iframe id="shinyapp" src="https://b4billy.shinyapps.io/scenario-trees/" style="border: none; width: 100%; height: 800px" frameborder="0">
  </iframe>
</center>